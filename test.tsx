import React, { useState, useRef, type UIEvent, useEffect } from "react"
...
export function TestFeaturesSection() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setSelectedFeatureIndex((prev) => (prev + 1) % features.length)
    }, 5000)
  ...
  return (
    <section id="features" className="py-16 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[hsl(var(--admin-background))] to-[hsl(var(--admin-gradient-end)/0.3)] opacity-50"></div>
      ...
      <div className="w-full lg:w-[90%] mx-auto relative z-10">
        <motion.div
        ...
        >
          <h2 className="text-3xl font-bold text-[hsl(var(--admin-foreground))] sm:text-4xl md:text-5xl">
            All-in-One <span className="text-[hsl(var(--admin-primary))]">Solution</span>
          </h2>
        ...
        <div className="lg:flex lg:items-center lg:gap-12 lg:min-h-[500px]">
          ...
          >
            <div
              className="relative w-full overflow-hidden rounded-xl shadow-2xl bg-[hsl(var(--admin-card))] border border-[hsl(var(--admin-border))]"
            ...
            >
              ...
              >
                <img
                  src={features[selectedFeatureIndex].imageUrl || "/placeholder.svg"}
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[hsl(var(--admin-background)/0.9)] to-transparent p-4">
                <motion.div
          ...
          >
            ...
            <div
              ...
              className="lg:hidden flex overflow-x-auto space-x-3 pb-6 -mx-4 px-4 snap-x snap-mandatory scrollbar-hide"
              onScroll={handleScroll}
            >
              {features.map((feature, index) => (
                <div key={index} className="min-w-[280px] w-[85vw] max-w-[340px] p-1 snap-center flex-shrink-0">
                  <button
                    onClick={() => setSelectedFeatureIndex(index)}
                    className={cn(
                      `w-full h-full p-5 rounded-xl text-left transition-all duration-300 border-2`,
                      selectedFeatureIndex === index
                        ? "bg-gradient-to-br from-[hsl(var(--admin-primary))] to-[hsl(var(--admin-primary)/0.8)] text-[hsl(var(--admin-primary-foreground))] shadow-lg border-transparent scale-105"
                        : "bg-[hsl(var(--admin-card))] hover:bg-[hsl(var(--admin-muted))] border-[hsl(var(--admin-border))] text-[hsl(var(--admin-foreground))] hover:border-[hsl(var(--admin-primary)/0.5)]",
                    )}
                  >
                    <div className="flex items-center mb-3">
                      <div
                        className={cn(
                          `w-10 h-10 rounded-lg flex items-center justify-center mr-3 flex-shrink-0 transition-all duration-300`,
                      ...
                      >
                        {React.cloneElement(feature.icon, {
                          className: cn(
                            ...
                            selectedFeatureIndex === index ? "text-white" : "text-[hsl(var(--admin-primary))]",
                          ),
                        })}
                      </div>
                    ...
                    <p
                      className={cn(
                        ...
                        selectedFeatureIndex === index
                          ? "text-[hsl(var(--admin-primary-foreground))/0.9]"
                          : "text-[hsl(var(--admin-foreground)/0.7)]",
                      )}
                    >
                      {feature.description}
                    </p>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        selectedFeatureIndex === index
                          ...
                          : "w-2 h-2 bg-[hsl(var(--admin-primary)/0.4)] hover:bg-[hsl(var(--admin-primary)/0.6)]",
                      )}
            ...
            <div className="hidden lg:grid grid-cols-2 gap-4">
              {features.map((feature, index) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={cn(
                    `p-5 rounded-xl text-left transition-all duration-300 border-2 h-full`,
                    selectedFeatureIndex === index
                      ? "bg-gradient-to-br from-[hsl(var(--admin-primary))] to-[hsl(var(--admin-primary)/0.8)] text-[hsl(var(--admin-primary-foreground))] shadow-lg border-transparent"
                      : "bg-[hsl(var(--admin-card))] hover:bg-[hsl(var(--admin-muted))] border-[hsl(var(--admin-border))] text-[hsl(var(--admin-foreground))] hover:border-[hsl(var(--admin-primary)/0.5)]",
                  )}
                >
                  <div className="flex items-center mb-3">
