        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center mb-6">
              ...
              <div className="ml-4">
                ...
                <p className="text-yellow-600">Taco Truck Owner</p>
              </div>
            </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center mb-6">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-semibold text-gray-900">Mike Chen</h4>
                <p className="text-yellow-600">Pizza Truck Owner</p>
              </div>
            </div>
            <div className="flex mb-4">
              {[...Array(5)].map((_, i) => (
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center mb-6">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-semibold text-gray-900">Lisa Rodriguez</h4>
                <p className="text-yellow-600">Ice Cream Truck Owner</p>
              </div>
            </div>
            <div className="flex mb-4">
              {[...Array(5)].map((_, i) => (
