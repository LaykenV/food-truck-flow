...
export function LivePreview() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
      ...
      <div className="h-[600px] overflow-y-auto">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              ...
              <div className="flex items-center">
                <a 
                  href="#" 
                  className="p-2 rounded-md text-white font-medium hover:opacity-90 transition-opacity"
            ...
            {config.hero.image && (
              <div className="absolute inset-0">
                <Image 
                  ...
                  onError={(e) => {
                    // Add a background color if image fails to load
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">123 Main Street, City, State 12345</p>
      ...
      {/* Preview Controls */}
      <div className="p-3 bg-gray-100 border-t border-gray-200 flex justify-center">
