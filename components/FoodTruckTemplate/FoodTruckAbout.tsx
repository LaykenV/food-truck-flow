      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                <div className="p-3 rounded-full mb-4" style={{ backgroundColor: `${primaryColor}22` }}>
                  <MapPin className="h-6 w-6" style={{ color: primaryColor }} />
                </div>
                <h3 className="font-bold text-lg mb-2" style={{ color: primaryColor }}>Find Us</h3>
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                <div className="p-3 rounded-full mb-4" style={{ backgroundColor: `${secondaryColor}22` }}>
                  <Clock className="h-6 w-6" style={{ color: secondaryColor }} />
                </div>
                <h3 className="font-bold text-lg mb-2" style={{ color: secondaryColor }}>Hours</h3>
                <p className="text-gray-600">
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-bold text-lg mb-2" style={{ color: primaryColor }}>Contact</h3>
                <p className="text-gray-600">
